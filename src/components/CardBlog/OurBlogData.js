...
export const BlogInfo = [
  {
    ...
    description:
      "I knew I had to have these velvet Tibi boots when I first saw them a few months back.",
    path: "/",
  },
  {
    thumbnail: blog2,
    ...
    description:
      "I’m so excited, I picked up my wedding dress from alterations last week.",
    path: "/",
  },
  {
    thumbnail: blog3,
    ...
    description:
      "One shoe I will never get tired of: a good lace-up sandal. The ones I picked above are on my dream list.",
    path: "/",
  },
];
